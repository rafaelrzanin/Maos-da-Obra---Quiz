...
export const ResultsScreen = () => {
  ...
  // --- ALTERAÇÃO AQUI ---
  // Agora mandamos para o /register para criar a conta antes de pagar
    ...
    <div className="flex flex-col h-full bg-[#F8FAFC] overflow-y-auto no-scrollbar scroll-smooth w-full relative">
      ...
      <div className="px-6 py-12 bg-white relative z-20 -mt-12 rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
        ...
        <div className="space-y-4 mb-8">
          ...
          <PainCard icon={<Ban size={22} className="text-slate-700" />} title="Desperdício Invisível" text="Sem conferência, 15% do cimento some ou estraga." />
        </div>
